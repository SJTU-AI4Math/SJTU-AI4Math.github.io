  ...
  'zh-CN': {
    translation: {
      ...
      summerSchool: {
        title: '2026 暑期学校',
        dates: '8 月 23–30 日',
        lead: '类型论、Lean 4、形式化数学与 AI4Math 的八日暑期学校',
        onThisPage: '本页导航',
        schedule: '日程安排',
        scheduleIntro: '八天课程、实践与课题报告。',
        courses: '课程内容',
        coursesNav: '课程',
        ...
        venue: '地点与校园地图',
        venueNav: '地点',
        venueIntro: '主要教学地点为光彪楼 206；8 月 28 日课程安排在理科群楼 5-6 号楼 300。',
        mapAlt: '上海交通大学校园地图',
        openMap: '打开方块交大地图',
        notes: '行前须知',
  ...
  en: {
    translation: {
      ...
      summerSchool: {
        ...
        dates: 'August 23–30',
        lead: 'Eight days of type theory, Lean 4, formal mathematics, and AI4Math',
        onThisPage: 'On this page',
        schedule: 'Schedule',
        scheduleIntro: 'Eight days of courses, project work, and presentations.',
        courses: 'Courses',
        coursesNav: 'Courses',
        ...
        venueNav: 'Venues',
        venueIntro: 'Most teaching takes place in Guangbiao Building, Room 206. Courses on August 28 are in Science Buildings 5–6, Room 300.',
